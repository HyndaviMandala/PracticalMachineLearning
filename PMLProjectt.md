...
![](PMLProjectt_files/figure-html/unnamed-chunk-6-1.png)<!-- -->
...
![](PMLProjectt_files/figure-html/unnamed-chunk-13-1.png)<!-- -->
...
![](PMLProjectt_files/figure-html/unnamed-chunk-14-1.png)<!-- -->

```r
plot(mod_rf)
```

![](PMLProjectt_files/figure-html/unnamed-chunk-14-2.png)<!-- -->

```r
plot(mod_gbm)
```

![](PMLProjectt_files/figure-html/unnamed-chunk-14-3.png)<!-- -->
